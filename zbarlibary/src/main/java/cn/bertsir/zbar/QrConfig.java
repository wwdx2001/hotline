...
public class QrConfig implements Serializable {
    ...
    public static final String QR_SCAN_KEY = "QR_SCAN_KEY";//二维码状态
    public static final String QR_INSTORE_CHECK = "QR_INSTORE_CHECK";//入库校验
    public static final String QR_OUTSTORE_CHECK = "QR_OUTSTORE_CHECK";//出库校验
    public static final String QR_INVENTORY_CHECK = "QR_INVENTORY_CHECK";//盘点校验
    public static final String QR_REFUNDSTORE_CHECK = "QR_REFUNDSTORE_CHECK";//退库校验
    public static final String QR_SHELVES_MODIFY = "QR_SHELVES_MODIFY";//货架调整
    public static final String QR_S_DINGDANBH = "QR_S_DINGDANBH";//请购单号
    public static final String QR_OUT_STORE = "QR_OUT_STORE";//水表出库
