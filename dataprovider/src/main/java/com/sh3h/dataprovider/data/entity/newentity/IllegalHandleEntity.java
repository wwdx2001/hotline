...
@Entity
public class IllegalHandleEntity {
    ...
    @Generated(hash = 354428443)
    public IllegalHandleEntity(Long ID, String albh, String pch, String xh,
    ...
    @Generated(hash = 744886188)
    public IllegalHandleEntity() {
    }
