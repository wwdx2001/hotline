...
public class SystemConfig extends BaseConfig {
     ...
     * 数据后台外网地址
     */
    public static final String PARAM_SERVER_BASE_URI_OTHER = "server.baseuri_other";
     ...
     * 数据后台内网地址
     */
    public static final String PARAM_RESERVED_SERVER_BASE_URI_OTHER = "server.reserved.baseuri_other";
    ...
    public static final String PARAM_SYS_HANDLE_TYPE = "sys.handle.type.value";
    ...
    public static final String PARAM_SYS_MDWIKI = "sys.wiki.server";
