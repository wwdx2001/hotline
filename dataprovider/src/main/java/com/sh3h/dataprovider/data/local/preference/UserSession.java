...
public class UserSession {
    ...
    private void readSharedPreferences() {
        ...
        if (sp != null) {
            ...
            set_accessToken(sp.getString(KEY_ACCESS_TOKEN, TextUtil.EMPTY));
    ...
    public boolean save() {
        ...
        if (TextUtil.isNullOrEmpty(_accessToken)) {
            editor.putString(KEY_ACCESS_TOKEN, TextUtil.EMPTY);
        } else {
            editor.putString(KEY_ACCESS_TOKEN, _accessToken);
        }
        // 记录用户account
