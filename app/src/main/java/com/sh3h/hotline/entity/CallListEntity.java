...
public class CallListEntity implements Serializable {
    ...
    public void setQfkl(String qfkl) {
        this.qfkl = qfkl;
    }

    public String getQfkl() {
        return qfkl;
    }

    public void setQfzje(String qfzje) {
        this.qfzje = qfzje;
    }
    ...
    public void setKzcm(String kzcm) {
        this.kzcm = kzcm;
    }

    public String getKzcm() {
        return kzcm;
    }

    public void setKzsl(String kzsl) {
        this.kzsl = kzsl;
    }

    public String getKzsl() {
        return kzsl;
    }
    ...
    public void setFjzdxq(String fjzdxq) {
        this.fjzdxq = fjzdxq;
    }

    public String getFjzdxq() {
        return fjzdxq;
    }
