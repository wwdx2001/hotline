...
public class IllegalHandlePresenter extends ParentPresenter<IllegalHandleMvpView> {
    ...
    @Inject
    public IllegalHandlePresenter(DataManager dataManager, ConfigHelper configHelper
    ...
    IllegalHandleEntity handleOrderEntity;
    DUMyTask duMyTask;

    public void commitMyTaskInfo(DUMyTask duMyTask, IllegalHandleEntity handleOrderEntity) {
            ...
            public void onSuccess(String s) {
                ...
                if (uploadSuccess.getState() == 0) {
                    ...
                    if (handleOrderEntity != null) {
                        GreenDaoUtils.getDaoSession(MainApplication.getInstance()).getIllegalHandleEntityDao()
