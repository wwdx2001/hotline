 ...
 */
public class HistoryOrdersPresenter extends ParentPresenter<HistoryOrdersMvpView> {

    private final static String TAG = "HistoryOrdersPresenter";
    private String mAccount = "";
    private Handler mHandler = new Handler(Looper.getMainLooper());

    @Inject
    public HistoryOrdersPresenter(DataManager dataManager) {
        super(dataManager);
