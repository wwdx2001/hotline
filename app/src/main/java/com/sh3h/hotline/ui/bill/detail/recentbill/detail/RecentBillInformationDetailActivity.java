...
public class RecentBillInformationDetailActivity extends ParentActivity implements RecentBillInformationDetailMvpView {

    @Inject
    RecentBillInformationDetailPresenter mPresenter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initToolBar(R.string.activity_recent_bill_information_detail);
    ...
    public void initData(DURecentBillDetail data) {
        ...
        tvChaobiaoriqi.setText(new SimpleDateFormat("yyyy-MM-dd").format(new Date(data.getReadTime())));
