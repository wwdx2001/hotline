...
public class IllegalWaterActivity extends ParentActivity implements RadioGroup.OnCheckedChangeListener, IllegalHandleMvpView {
    ...
    @Inject
    IllegalHandlePresenter mHandleOrderPresenter;
    ...
    //详细
    private IllegalWaterDetailFragment mOrderDetailsFragment;

    //处理
    private IllegalWaterHandleFragment mHandleOrderFragment;

    //历史-处理
    private IllegalWaterHistoryFragment mHistoryHandleOrderFragment;
    ...
    private IllegalHandleEntity handleEntity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_illegal_water);
...
//            throw new NullPointerException("intent is null");
    ...
    private void saveData() {
        ...
        handleEntity = new IllegalHandleEntity();
...
//        handleEntity.setYhh(mDuMyTask.getYhh());
        ...
        GreenDaoUtils.getDaoSession(this).getIllegalHandleEntityDao().insertOrReplace(handleEntity);
...
//                uploadData(psfs, sfsd, wqsyy, wqsyy, ghxdh, qsr, sjrsf, xxbg, tyshxydm, khmc, lxr, lxfs, yjdz, bz);
    ...
    protected void onRestoreInstanceState(Bundle savedInstanceState) {
        ...
        mOrderDetailsFragment = (IllegalWaterDetailFragment) getSupportFragmentManager().
                findFragmentByTag(IllegalWaterDetailFragment.class.getName());
        mMultimediaFragment = (MultimediaFragment) getSupportFragmentManager().
                findFragmentByTag(MultimediaFragment.class.getName());
        mHandleOrderFragment = (IllegalWaterHandleFragment) getSupportFragmentManager().
                findFragmentByTag(IllegalWaterHandleFragment.class.getName());
        //历史-处理
        mHistoryHandleOrderFragment = (IllegalWaterHistoryFragment) getSupportFragmentManager().
                findFragmentByTag(IllegalWaterHistoryFragment.class.getName());
        if (saveName.equals(IllegalWaterDetailFragment.class.getName())) {
        ...
        } else if (saveName.equals(IllegalWaterHandleFragment.class.getName())) {
            if (mMultimediaFragment != null) {
                fts.hide(mMultimediaFragment);
            }
            if (mHistoryHandleOrderFragment != null) {
        ...
        } else if (saveName.equals(IllegalWaterHistoryFragment.class.getName())) {
            if (mMultimediaFragment != null) {
                fts.hide(mMultimediaFragment);
            }
            if (mHandleOrderFragment != null) {
    ...
    private void initOrderDetailFragment() {
        if (mOrderDetailsFragment == null) {
            mOrderDetailsFragment = new IllegalWaterDetailFragment();
...
//            if (mHistoryHandleOrderFragment == null) {
//                mHistoryHandleOrderFragment = new IllegalWaterHistoryFragment();
//                Bundle bundle = new Bundle();
...
//        }
        ...
        if (mHandleOrderFragment == null) {
            mHandleOrderFragment = new IllegalWaterHandleFragment();
            Bundle bundle = new Bundle();
            bundle.putParcelable(Constant.DUMyTask, mDuMyTask);
            bundle.putInt(Constant.TASKSTATE, mState);
            bundle.putString(Constant.TASK_ID, mTaskId);
