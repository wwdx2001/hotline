...
public class RemoteHandlePresenter extends ParentPresenter<RemoteHandleMvpView> {
    ...
    @Inject
    public RemoteHandlePresenter(DataManager dataManager, ConfigHelper configHelper
    ...
    RemoteHandleEntity handleOrderEntity;
    DUMyTask duMyTask;

    public void commitMyTaskInfo(DUMyTask duMyTask, RemoteHandleEntity handleOrderEntity) {
...
//                .writeTimeOut(3*60*1000)
    ...
    private void commitInfo(final String msg, final String taskId, final int taskType, final int taskState) {
        ...
        PostRequest request = EasyHttp
                ...
                .params("cbds", handleOrderEntity.getCbds())
                .params("dssj", handleOrderEntity.getDssj())
                .params("bz", handleOrderEntity.getBz())
            ...
            public void onSuccess(String s) {
                ...
                if (uploadSuccess.getState() == 0) {
                    ...
                    if (handleOrderEntity != null) {
                        GreenDaoUtils.getDaoSession(MainApplication.getInstance()).getRemoteHandleEntityDao()
