 ...
 */
public class HistorySaveOrdersPresenter extends ParentPresenter<HistorySaveOrdersMvpView> {

    private final static String TAG = "HistorySaveOrdersPresenter";
    private String mAccount = "";
    private Handler mHandler = new Handler(Looper.getMainLooper());

    @Inject
    public HistorySaveOrdersPresenter(DataManager dataManager) {
        super(dataManager);
