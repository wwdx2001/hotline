...
public class CallBillDetailNewActivity extends ParentActivity {

    @BindView(R.id.tv_hjqfje)
    TextView tvHjqfje;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_call_bill_detail_new);
    ...
    private void initTabRecyclerView() {
        ...
        mTabAdapter = new CallBillTabAdapter(R.layout.item_call_bill_tab_new, tabItemBeans);
    ...
    private void initData() {
        ...
        String qfje = getIntent().getStringExtra("qfje");
        tvHjqfje.setText(qfje);
