 ...
 */
public class ReceiptNewPresenter extends ParentPresenter<ReceiptMvpView> {
    ...
    @Inject
    public ReceiptNewPresenter(DataManager dataManager,
     ...
     * 保存并上传工单
     */
    public void saveAndCommitOrder(final CreateSelfOrderNewActivity activity, boolean isCheckbox, final ZikaidanJLEntity zikaidanJLEntity) {
...
//                .writeTimeOut(3*60*1000)
    ...
    private void commZiKaidanInfo(final String msg) {
        ...
        if("催缴工单".equals(zikaidanJLEntity.getFylx())){
            HttpParams params = new HttpParams();
            params.put("zhbh", zikaidanJLEntity.getZhbh());
            params.put("userId", SPUtils.getInstance().getString(Constant.USERID));
            mDisposable2 = EasyHttp.post(URL.CuiJiaoSelfOpeningOrder)
                    .params(params)
        ...
        }else if("奖励工单".equals(zikaidanJLEntity.getFylx())&&"违章用水".equals(zikaidanJLEntity.getFanyingNR())){
            HttpParams params = new HttpParams();
            params.put("fylb", zikaidanJLEntity.getFanyingLX());
            params.put("fybr", zikaidanJLEntity.getFanyingNR());
            params.put("ghs", zikaidanJLEntity.getGls());
            params.put("zd", zikaidanJLEntity.getSszd());
            params.put("zhbh", zikaidanJLEntity.getZhbh());
            params.put("wzzt", zikaidanJLEntity.getWzzt());
            params.put("wzdd", zikaidanJLEntity.getWzdd());
            params.put("wznr", zikaidanJLEntity.getWznr());
            params.put("xcqkbz", zikaidanJLEntity.getXcqkbz());

            params.put("xczp1", fj1);
            params.put("xczp2", fj2);
            params.put("xczp3", fj3);
            params.put("sp", sp);
            params.put("ly", ly);
            params.put("cbyid", SPUtils.getInstance().getString(Constant.USERID));
            mDisposable2 = EasyHttp.post(URL.WeiZhangYSSelfOpeningOrder)
                    .params(params)
                    .execute(new CallBackProxy<CustomApiResult<ServiceResultEntity>,
                            ServiceResultEntity>(new CustomCallBack<ServiceResultEntity>() {
                        @Override
        ...
        }else if("奖励工单".equals(zikaidanJLEntity.getFylx())&&"疑问水表".equals(zikaidanJLEntity.getFanyingNR())){
            HttpParams params = new HttpParams();
            params.put("fylb", zikaidanJLEntity.getFanyingLX());
            ...
            params.put("zd", zikaidanJLEntity.getSszd());
            params.put("zhbh", zikaidanJLEntity.getZhbh());
            params.put("jlbbh", zikaidanJLEntity.getMpbh());
            params.put("ywlx", zikaidanJLEntity.getYwlx());
            params.put("xccm", zikaidanJLEntity.getXccm());
            params.put("ysdz", zikaidanJLEntity.getFashengDZ());
            params.put("xcqkbz", zikaidanJLEntity.getXcqkbz());
            params.put("htr", SPUtils.getInstance().getString(Constant.USERID));
            params.put("cbyid", SPUtils.getInstance().getString(Constant.USERID));
            ...
            params.put("sp", sp);
            params.put("ly", ly);
            mDisposable2 = EasyHttp.post(URL.YiWenSBSelfOpeningOrder)
                    .params(params)
                    .execute(new CallBackProxy<CustomApiResult<ServiceResultEntity>,
                            ServiceResultEntity>(new CustomCallBack<ServiceResultEntity>() {
                        @Override
